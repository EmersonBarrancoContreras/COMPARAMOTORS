...
@Component({
  ...
  standalone: true,
  imports: [FooterComponent, SliderComponent, PublicityComponent, HeaderComponent, Seccion1Component, Seccion2Component, Seccion3Component, Notice1Component, Notice2Component, Notice3Component, Notice4Component, Notice5Component, Notice6Component, CtaComponent],
